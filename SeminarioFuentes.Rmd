...
```{r GraficaSuina1}
#Regresión lineal suina salud mental
suina_plot2.1 <-
  ggplot(data = suina, aes(x = porPobSui, y = porPobIna)) +
  geom_point()+
  geom_smooth(method = "lm", colour = "blue")+
...
![Gráfica Relación Suicidios e Innacesibilidad por Salud Mental RL](OUTPUT/DATA/Relación_Suicidios_Innacesibilidad_SaludMental_RL.jpg "Relación Suicidios e Innacesibilidad por Salud Mental Regrasión Lineal")
