...
### Gráfica suicidios-cocientes80s20
...
En este caso el valor de la correlación ha sido de -0.34, no es un valor muy representativo pero nos indica que la correlación en negativa, sin embargo, es un valor muy bajo.
...
![Gráfica Relación Suicidios Innacesibilidad (Salud Mental)](OUTPUT/DATA/Relación_Suicidios_Innacesibilidad_SaludMental.jpg "Relación_Suicidios e Innacesibilidad por Salud Mental")
...
![Gráfica Relación Desigualdad Innacesibilidad](OUTPUT/DATA/Relación_Desigualdad_Innacesibilidad.jpg "Relación Desigualdad e Innacesibilidad")
...
![Gráfica Relación Suicidios e Innacesibilidad por Atención Médica](OUTPUT/DATA/Relación_Suicidios_Innacesibilidad_AtencionMedica.jpg "Relación Suicidios e Innacesibilidad por Atencion Medica")
...
![Gráfica Relación Suicidios e Innacesibilidad por Medicamento Recetado](OUTPUT/DATA/Relación_Suicidios_Innacesibilidad_MedicamentoRecetado.jpg "Relación Suicidios e Innacesibilidad por Medicamento Recetado")
...
![Gráfica Comparativa Relación Suicidios e Innacesibilidad Regresión Lineal](OUTPUT/DATA/Relación_Suicidios_Innacesibilidad_Comparacion.jpg "Relación Suicidios e Innacesibilidad Comparativa")
## Análisis
A simple vista resulta difícil poder analizar los datos por eso y para ser más objetivos durante el estudio se ha hecho un análisis de correlación (muestra si hay relación entre los datos pero no especifica si hay causalidad) y una revisión de los parámetros obtenidos en las regresiones anteriores.
